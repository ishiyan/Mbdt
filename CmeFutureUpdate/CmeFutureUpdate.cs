            ...
            new Future
            {
                ...
                Series = new List<SeriesEntry>
                {
                 ...
                 //new SeriesEntry { Code="ESM22", Month = "JUN 2022", MonthShortcut="JUN-22", FirstTradeDate=new DateTime(2021,  3, 19), LastTradeDate=new DateTime(2022,  6, 17), SettlementDate=new DateTime(2022,  3, 18), RolloverDate=new DateTime(2022,  6,  9)},
                   ...
                   new SeriesEntry { Code="ESZ22", Month = "DEC 2022", MonthShortcut="DEC-22", FirstTradeDate=new DateTime(2021,  9, 13), LastTradeDate=new DateTime(2022, 12, 16), SettlementDate=new DateTime(2022, 12, 16), RolloverDate=new DateTime(2022, 12,  8)},
                   new SeriesEntry { Code="ESH23", Month = "MAR 2023", MonthShortcut="MAR-23", FirstTradeDate=new DateTime(2021, 12, 17), LastTradeDate=new DateTime(2023,  3, 17), SettlementDate=new DateTime(2023,  3, 16), RolloverDate=new DateTime(2023,  3,  9)},
                   new SeriesEntry { Code="ESM23", Month = "JUN 2023", MonthShortcut="JUN-23", FirstTradeDate=new DateTime(2022,  3, 17), LastTradeDate=new DateTime(2023,  6, 16), SettlementDate=new DateTime(2023,  6, 16), RolloverDate=new DateTime(2023,  6,  9)},
                   new SeriesEntry { Code="ESU23", Month = "SEP 2023", MonthShortcut="SEP-23", FirstTradeDate=new DateTime(2022,  6, 18), LastTradeDate=new DateTime(2023,  9, 15), SettlementDate=new DateTime(2023,  9, 15), RolloverDate=new DateTime(2023,  9,  9)},
                   new SeriesEntry { Code="ESZ23", Month = "DEC 2023", MonthShortcut="DEC-23", FirstTradeDate=new DateTime(2022,  9, 13), LastTradeDate=new DateTime(2023, 12, 15), SettlementDate=new DateTime(2023, 12, 15), RolloverDate=new DateTime(2023, 12,  9)}//,
                },
