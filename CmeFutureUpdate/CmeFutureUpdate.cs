        ...
        private readonly List<Future> futureList = new List<Future>
        {
            new Future
            {
                ...
                Series = new List<SeriesEntry>
                {
                 ...
                 //new SeriesEntry { Code="ESM24", Month = "JUN 2024", MonthShortcut="JUN-24", FirstTradeDate=new DateTime(2022, 12, 17), LastTradeDate=new DateTime(2024,  3, 15), SettlementDate=new DateTime(2024,  3, 15), RolloverDate=new DateTime(2024,  3, 11)}//,
                },
